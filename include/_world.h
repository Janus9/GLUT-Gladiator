...
enum TileId : uint8_t {
    ...
    // Floor Middle Dry //
    TILE_FLOOR_OUTER_DEFAULT_1_DRY,
    TILE_FLOOR_OUTER_DEFAULT_2_DRY,

    // Floor Middle Wet //
    TILE_FLOOR_OUTER_DEFAULT_1_WET,
    TILE_FLOOR_OUTER_DEFAULT_2_WET,

    // Floor Inner Dry //
    TILE_FLOOR_INNER_DEFAULT_1_DRY,
    TILE_FLOOR_INNER_DEFAULT_2_DRY,

    // Floor Inner Wet //
    TILE_FLOOR_INNER_DEFAULT_1_WET,
    TILE_FLOOR_INNER_DEFAULT_2_WET,

    // Floor Broken //
    TILE_FLOOR_BROKEN_INNER,
